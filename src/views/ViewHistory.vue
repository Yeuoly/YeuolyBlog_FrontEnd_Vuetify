<template>
    <VContainer>
        <MaterialCard title="开发日志">
            <VCard flat>
                <VTimeline align-top dense>
                    <VTimelineItem small
                                   v-for="( t , key ) in history"
                                   :key="key"
                                   :color="t.color"
                    >
                        <VLayout pt-3>
                            <VFlex xs5 sm3 md2 lg2>
                                <h5>{{t.date}}</h5>
                                <h6>{{t.version}}</h6>
                            </VFlex>
                            <VFlex xs7 sm9 md10 lg10>
                                <h4>{{t.title}}</h4>
                                <h6>{{t.content}}</h6>
                            </VFlex>
                        </VLayout>
                ...
                history :  [
                    {
                        title   : '修复、优化',
                        version : '2.2.2.01-β',
                        content : '修复无法登出的问题，修复latex和代码块在长度过大时会缩起来的问题，修复渲染器无限循环的问题，修复单页博客无法直接进入编辑器的问题，修复头图404的问题',
                        date    : '2021/1/19',
                        color   : 'blue'
                    },
                    {
